...
Функция ПолучитьЗначениеЭтоФронт() Экспорт
	
	Возврат Константы.отусЭтоФронтОфис.Получить();
	
КонецФункции

Функция ПолучитьЗначениеТекущегоСклада() Экспорт
	
	Возврат Константы.отусТекущийСкладФронта.Получить();
